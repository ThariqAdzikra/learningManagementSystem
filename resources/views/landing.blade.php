...
<body>
    ...
    <div class="header">
        ...
        <div class="header-actions">
            @auth
                ...
                <span style="margin-right: 1rem;">Hi, {{ Auth::user()->first_name }}!</span>
                ...
                <form method="POST" action="{{ route('logout') }}" style="display: inline;">
                    @csrf
                    <button type="submit"
                        style="background: none; border: none; color: var(--off-white); text-decoration: none; margin-left: 1rem; padding: 0.5rem 1rem; border-radius: 8px; cursor: pointer; transition: all 0.3s ease;">Logout</button>
                </form>
            @else
    ...
    <div class="hero-section">
        ...
        <p>SmartPal helps students and lecturers manage their learning and teaching activities seamlessly, all in one
            place.</p>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="testimonial-card">
                            <p>"SmartPal makes my life so much easier as a student. Everything I need is in one place!"
                            </p>
                    ...
                    <div class="carousel-item">
                        <div class="testimonial-card">
                            <p>"As a lecturer, SmartPal has streamlined my teaching process significantly."</p>
    ...
    <div class="footer">
        © {{ date('Y') }} Developed with a smile by SmartPal group.
    </div>
