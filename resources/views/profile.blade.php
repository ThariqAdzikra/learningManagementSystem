...
<div class="container d-flex justify-content-center align-items-center" style="flex: 1;">
    <div class="profile-card">
        ...
        <form action="{{ route('profile.update') }}" method="POST">
            ...
            <div class="mb-3">
                <input type="text" class="form-control" placeholder="Status" name="status" value="{{ $user->role }}" disabled>
            </div>
            ...
            <div class="mb-3">
                <div class="input-group">
                    <input type="password" class="form-control" placeholder="Konfirmasi Password Baru" name="new_password_confirmation">
                    <span class="input-group-text-custom"><i class="fas fa-sync-alt"></i></span>
                </div>
            </div>
